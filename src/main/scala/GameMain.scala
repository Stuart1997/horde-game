...
object GameMain extends App {
  ...
  //Sort the tuple based on the score, descending, print (_: goes through all tuples, _2 looks only at ints)
  //Each tuple has been assigned a value, and then it's ordered by tuple value
